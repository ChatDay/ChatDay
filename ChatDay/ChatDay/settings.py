"""
Django settings for ChatDay project.
...
WSGI_APPLICATION = 'ChatDay.wsgi.application'
...
# ASGI 설정
ASGI_APPLICATION = 'ChatDay.asgi.application'

# Channels layer를 위한 Redis 설정
CHANNEL_LAYERS = {
    'default': {
